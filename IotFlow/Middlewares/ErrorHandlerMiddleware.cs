...
using System.Net;
using IotFlow.Models.Errors;
using IotFlow.Models.Exceptions;

namespace IotFlow.Middlewares
{
    public class ErrorHandlerMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            catch (Exception ex)
            {
                ...
                await context.Response.WriteAsync(response.ErrorMessage.ToString());
            }
        }
    }
}
