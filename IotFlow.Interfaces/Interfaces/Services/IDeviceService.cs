...
{
    public interface IDeviceService<TDeviceDto, TRegisterDeviceDto, TUpdateDeviceDto, TMethodDto, TDeviceAliveDto> where TDeviceDto : IDeviceDto where TRegisterDeviceDto : IDeviceDto
    {
        ...
        public Task SendCommandAsync(Guid deviceGuid, int userId, string command, CancellationToken cancellationToken = default);
